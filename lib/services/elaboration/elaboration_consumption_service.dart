...
class ElaborationConsumptionService {
  final Box<IngredientCatalog> ingredientBox = Hive.box<IngredientCatalog>(
    'ingredients',
  );

  final Box<InventoryMovement> movementBox = Hive.box<InventoryMovement>(
    'inventory_movements',
  );

  Future<void> consume(List<ConsumptionItem> consumption) async {
